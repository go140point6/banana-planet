...
export class Monster extends Fighter {
  ...
  constructor(player: Player) {
    ...
    if (this.diff < 1) {
      //console.log("Player is weaker!"); //debug
      if (this.diff >= 0.97) {
        this.relative = 2;
      } else {
        this.relative = 1;
    ...
    if (this.diff == 1) {
      //console.log("Player and Monster are evenly matched"); //debug
      this.relative = 3;
    }
